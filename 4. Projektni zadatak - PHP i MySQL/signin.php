...
include("dbconn.php");
	...
	if ($_POST['_action_'] == FALSE) {
        ...
        if ($row['approval'] == 'N') {
            unset($_SESSION['user']);
            echo '<p id="poruke">User must be approved by the administrator! <a href="index.php?menu=7">Back!</a> </p>';
        } else {
            if (password_verify($_POST['password'], $row['password'])) {
                ...
                unset($_SESSION['user']);
                $_SESSION['message'] = '<p id="poruke">You entered wrong email or password!</p>';
