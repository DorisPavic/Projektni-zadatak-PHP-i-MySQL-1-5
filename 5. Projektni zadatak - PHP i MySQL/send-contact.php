...
<html>
	<head>
        ...
        <meta name="author" content="dpavic@tvz.hr">
		<!-- favicon meta -->
		...
		<!-- End Google Fonts -->
		<title>Welcome to Lovište!</title>
	</head>
<body>
	<header>
		<div class="welcome" style="height: 200px;"></div>
		<nav>
			<ul>
	...
	<main>
		...
		<div id="contact">
			...
			<?php
				...
				$EmailHeaders .= "From: <dpavic@tvz.hr>\r\n";
				$EmailHeaders .= "Reply-To:<pavicdoris@gmail.com>\r\n";
	...
	<footer>
		<p>Copyright &copy; 2021 Doris Pavić</p>
	</footer>
