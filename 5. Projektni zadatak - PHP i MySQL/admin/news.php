...
if (isset($_POST['_action_']) && $_POST['_action_'] == 'add_news') {
    ...
    $_SESSION['message'] .= '<h2>You successfully added news!</h2>';
...
if (isset($_POST['_action_']) && $_POST['_action_'] == 'edit_news') {
    ...
    $_SESSION['message'] = '<h2>You successfully changed news!</h2>';
...
if (isset($_GET['delete']) && $_GET['delete'] != '') {
    ...
    $_SESSION['message'] = '<h2>You successfully deleted news!</h2>';
